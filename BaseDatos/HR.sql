...
-- Declarar variables
DECLARE
  v_country_id CHAR(2) := 'ES';
  v_country_name VARCHAR2(40) := 'Spain';
  v_region_id NUMBER;
BEGIN
  -- Obtener el region_id para la región 'Europe'
  ...
  DBMS_OUTPUT.PUT_LINE('Region ID: ' || v_region_id);

  -- Insertar el registro en la tabla COUNTRIES
